...
urlpatterns = patterns('',
    ...
    (r'^escrowlogin/(?P<escrow_username>.+)/$', escrow_login, {}, 'escrow_login'),
    (r'^users/$', users, {}, 'users'),
    ...
    (r'^groups/(?P<username>.+)/$', groups_detail, {}, 'groups_detail'),
    (r'^groups/saved/$', groups, {'saved': True}, 'groups_saved'),
    (r'^shares/$', shares, {}, 'shares'),
    (r'^shares/saved/$', shares, {'saved': True}, 'shares_saved'),
    (r'^shares/(?P<email>.+)/(?P<room_key>.+)/$', share_detail, {}, 'share_detail'),
    (r'^manage/$', manage, {}, 'manage'),
